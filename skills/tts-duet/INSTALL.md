...
curl -L https://github.com/obeone/claude-skills/releases/download/v2.3.0/tts-duet.skill \
...
The pin `@v2.3.0` is intentional. **Do not change it without a reason**
...
Bump the pinned tag in the registration snippet (e.g. `@v2.3.0` →
